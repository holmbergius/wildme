...
$(".show-team-tab1").click(function(){
  ...
  $("#team-tab2, #team-tab3, #team-tab4, #team-tab5").hide();
  $("#tfp-1").addClass('selected');
  $("#tfp-2, #tfp-3, #tfp-4, #tfp-5").removeClass('selected');
});

//Tab 2
$(".show-team-tab2").click(function(){
  $("#team-tab2").show("fade", 600);
  $("#team-tab1, #team-tab3, #team-tab4, #team-tab4").hide();
  $("#tfp-2").addClass('selected');
  $("#tfp-1, #tfp-3, #tfp-4, #tfp-5").removeClass('selected');
});

//Tab 3
$(".show-team-tab3").click(function(){
  $("#team-tab3").show("fade", 600);
  $("#team-tab1, #team-tab2, #team-tab4, #team-tab5").hide();
  $("#tfp-3").addClass('selected');
  $("#tfp-2, #tfp-1, #tfp-4, #tfp-5").removeClass('selected');
});

//Tab 4
$(".show-team-tab4").click(function(){
  $("#team-tab4").show("fade", 600);
  $("#team-tab2, #team-tab3, #team-tab1, #team-tab5").hide();
  $("#tfp-4").addClass('selected');
  $("#tfp-2, #tfp-3, #tfp-1, #tfp-5").removeClass('selected');
});
...
$(".show-team-tab5").click(function(){
  ...
  $("#team-tab2, #team-tab3, #team-tab1, #team-tab4").hide();
  $("#tfp-5").addClass('selected');
  $("#tfp-2, #tfp-3, #tfp-1, #tfp-4").removeClass('selected');
});
