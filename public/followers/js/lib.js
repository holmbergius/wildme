...
function receiveMessage(event)
{
	 ...
	 $.post("//fb.wildme.org/wildme/public/api/follow",{user_id:global_user_id, animal_id:animal_id,'user_type':'website'},function(data){
