 ...
 * Copyright 2012 jQuery Foundation and other contributors; Licensed MIT */ (function ($, undefined) {
    var uuid = 0,
        runiqueId = /^ui-id-\d+$/;
    $.ui = $.ui || {};
    if ($.ui.version) {
...
jQuery.fn.imageLoader = function (k, c) {
    ...
    var a = this;
    var j = [];
    var e = (typeof b.images[0] == "object") ? true : false;
    g();
    ...
    function g() {
        if (b.endableSplashScreen) {
            var i = '<div id="imageLoaderSplashArea">' + ((b.enableSplashScreenImage) ? '' : "") + ((b.enableSplashScreenText) ? "" : "") + "</div>";
            $(a).append(i);
        }
    }
};
        ...
        $.extend($.fn, {
            miniColors: function (o, data) {
                var create = function (input, o, data) {
                    ...
                    var trigger = $('<a class="miniColors-trigger" style="cursor:pointer;background-color: #' + color + '"></a>');
                    ...
                    if (o.disabled || input.prop("disabled")) {
                        disable(input);
                    }
                ...
                var setColor = function (input, hsb, updateInput) {
                    ...
                    if (input.data("change")) {
                        if ((hex + "," + input.attr("data-opacity")) === input.data("lastChange")) {
                            return;
                        }
