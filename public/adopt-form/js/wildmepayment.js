...
var current_server = location.protocol+"//fb.wildme.org/wildme/public/";
var global_uid = 0;
...
function PutButton(){
	...
	$("#wildme-adoption-button").html('<link rel="stylesheet" href="//fb.wildme.org/wildme/public/adopt-form/css/style.css?timer=4" type="text/css"><div id="adoption_button" class="adopt-button"> <a href="javascript:;"><i></i> Adopt </a></div>');
		...
		$.ajax({
				...
				success:function(data){
						...
						if(data.status == 'success')
						{
							...
							$("#wildme-adoption-form").append('<link rel="stylesheet" href="//fb.wildme.org/wildme/public/adopt-form/css/adoption.css?timer=4" type="text/css"><div id="wildme_adopt-form" style="" class="popup"><div class="adopt-form-wrapper" style="min-height: 168px;"><span class="cross-icon-adopt"><img src="//fb.wildme.org/wildme/public/adopt-form/images/cross-icon.png" width="22" height="22" alt="" /></span> <div class="adopt-form-title"><div class="adopt-form-logo"><img src="//fb.wildme.org/wildme/public/images/logo.png" width="158" height="53" alt="" /></div></div><div style="" id="adopt-step4" class="adopt-slide"><div class="adopt-slide-inner"><p class="adopt-thank-you" style="text-align: center; ">Error While Adoption procedure, Please try again later</p><span id="close-adopt" class="close-text">Close</span></div></div></div>');	
							InitializeJs();
						}
					},
					error:function(err){
...
var popupHtml = '<link rel="stylesheet" href="//fb.wildme.org/wildme/public/adopt-form/css/adoption.css?timer=4" type="text/css"><div class="popup" style="display:none;" id="wildme_adopt-form">\
...
function shareAdoption()
{
  ...
  url = '//fb.wildme.org/wildme/public/share/'+animal_id;
