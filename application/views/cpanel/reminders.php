...
<div class="wrapper">
  <div class="container" style="padding:10px 10px 33px">
	<h1 style="font-size:28px;">Reminders (<span id="TotalReminders">0</span>)</h1>
<div style="float:right; width:550px; margin-top:-42px;">
  ...
  <a href="addReminder"><div class="btn blue add-btn " style="margin-top:5px;"><i class="icon-plus-sign"></i>Add Reminder</div></a>
    </span>
     ...
     <div class="alert-bar success" id="Message-success"  style="display:none ;font-size: 16px;margin-bottom: 15px;margin-top: 15px;text-align: center;" ><i class="icon-ok"></i></div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr class="title">
          ...
          <td width="300px" style=" font-size: 14px;">Title</td>
          <td width="300px" style=" font-size: 14px;">Time Interval</td>
          <td style=" font-size: 14px;">Actions</td>
        </tr>
        <tbody id="reminder_rows">
        </tbody>
      </table>
    </div>
